...
describe('Container - Behavior', () => {
  ...
  it('should default to centered and fluid', () => {
    container = mount(<Container />);
    const el = container.querySelector('[data-slot="container"]') as HTMLElement;
  ...
  it('should emit data-max-width attribute', () => {
    ...
    const el = container.querySelector('[data-slot="container"]');
    expect(el?.getAttribute(CONTAINER_A11Y_CONTRACT.DATA_ATTRIBUTES.maxWidth)).toBe('80rem');
  });
  ...
  it('should emit data-size attribute for named tokens', () => {
    ...
    const el = container.querySelector('[data-slot="container"]');
    expect(el?.getAttribute(CONTAINER_A11Y_CONTRACT.DATA_ATTRIBUTES.size)).toBe('lg');
  });
