...
import * as BadgeModule from '../../src/components/primitives/badge/index';
...
import * as ContainerModule from '../../src/components/primitives/container/index';
import * as FlexModule from '../../src/components/primitives/flex/index';
import * as GridModule from '../../src/components/primitives/grid/index';
...
import * as SeparatorModule from '../../src/components/primitives/separator/index';
import * as SkeletonModule from '../../src/components/primitives/skeleton/index';
import * as SliderModule from '../../src/components/primitives/slider/index';
import * as SpacerModule from '../../src/components/primitives/spacer/index';
...
import * as SidebarLayoutModule from '../../src/components/patterns/sidebar-layout/index';
import * as TopbarLayoutModule from '../../src/components/patterns/topbar-layout/index';

export const componentSurface = [
  { bucket: 'primitives', name: 'avatar', module: AvatarModule },
  { bucket: 'primitives', name: 'badge', module: BadgeModule },
  { bucket: 'primitives', name: 'button', module: ButtonModule },
  { bucket: 'primitives', name: 'checkbox', module: CheckboxModule },
  { bucket: 'primitives', name: 'container', module: ContainerModule },
  { bucket: 'primitives', name: 'flex', module: FlexModule },
  { bucket: 'primitives', name: 'grid', module: GridModule },
  ...
  { bucket: 'primitives', name: 'separator', module: SeparatorModule },
  { bucket: 'primitives', name: 'skeleton', module: SkeletonModule },
  { bucket: 'primitives', name: 'slider', module: SliderModule },
  { bucket: 'primitives', name: 'spacer', module: SpacerModule },
  ...
  { bucket: 'patterns', name: 'sidebar-layout', module: SidebarLayoutModule },
  { bucket: 'patterns', name: 'topbar-layout', module: TopbarLayoutModule },
] as const;
...
export const removedPublicExports = ["Center","Inline","Stack"] as const;
